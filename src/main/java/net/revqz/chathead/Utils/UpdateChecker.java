package net.revqz.chathead.Utils;
...
public class UpdateChecker {
    ...
    private final String API_URL = "https://api.github.com/repos/Javarev1/head-fonts/releases/latest";
        ...
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
            ...
            try {
                ...
                if (isVersionNewer(latestVersion, currentVersion)) {
                    ...
                    plugin.getLogger().info("Download: https://github.com/Javarev1/head-fonts/releases/latest");
                } else {
