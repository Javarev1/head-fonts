package net.revqz.chathead.API;

import net.kyori.adventure.text.Component;
import net.kyori.adventure.text.serializer.legacy.LegacyComponentSerializer;
import net.md_5.bungee.api.chat.BaseComponent;
import net.md_5.bungee.api.chat.TextComponent;
import net.revqz.chathead.API.impl.CrafatarSource;
import net.revqz.chathead.API.impl.McHeadsSource;
import net.revqz.chathead.API.impl.MinotarSource;
import net.revqz.chathead.API.impl.MojangSource;
import net.revqz.chathead.Main;
